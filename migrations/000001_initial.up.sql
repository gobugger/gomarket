...
CREATE TABLE wallets (
	id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
	balance_pico BIGINT NOT NULL DEFAULT 0 CHECK (balance_pico >= 0),
...
CREATE TABLE invoices (
	...
	amount_unlocked_pico BIGINT NOT NULL DEFAULT 0 CHECK (amount_unlocked_pico >= 0),
...
CREATE TABLE deposits (
	...
	amount_deposited_pico BIGINT NOT NULL DEFAULT 0 CHECK(amount_deposited_pico >= 0),
