...
CREATE TABLE wallets (
	id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
	balance_pico NUMERIC(39,0) NOT NULL DEFAULT 0 CHECK (balance_pico >= 0),
...
CREATE TABLE invoices (
	...
	amount_pico NUMERIC(39,0) NOT NULL CHECK (amount_pico > 0),
	status invoice_status NOT NULL DEFAULT 'pending'::invoice_status,
	amount_unlocked_pico NUMERIC(39,0) NOT NULL DEFAULT 0 CHECK (amount_unlocked_pico >= 0),
...
CREATE TABLE orders (
	...
	total_price_pico NUMERIC(39,0) NOT NULL CHECK (total_price_pico > 0), -- Total price of order in piconero
...
CREATE TABLE deposits (
	...
	amount_deposited_pico NUMERIC(39,0) NOT NULL DEFAULT 0 CHECK(amount_deposited_pico >= 0),
...
CREATE TABLE vendor_applications (
	...
	price_paid_pico NUMERIC(39,0) NOT NULL CHECK(price_paid_pico >= 0),
	user_id UUID REFERENCES users(id) NOT NULL,
	created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
	UNIQUE(user_id)
);
